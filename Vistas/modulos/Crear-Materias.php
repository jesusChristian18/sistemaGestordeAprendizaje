 					...
 					<tbody>
 						...
 						foreach ($resultado as $key => $value) {
 							...
 							if($value["programa"]!= ""){
 								...
 								echo '<td>Sin Material de desarrollo</td>';
 							}
 							
 							echo '<td>
 								<div class="btn-group">
 									<a href="http://localhost/universidad/Crear-Comisiones/'.$value["id"].'">
 										<button class="btn btn-default">Horarios</button>
 									</a>
 									<a href="">
 		...
 		<div class="modal-content">
 			<form method="post" enctype="multipart/form-data">
 				<div class="modal-body">
 					...
 					<div class="form-group">
 						...
 						<select class="form-control input-lg" name="tipo">
 							...
 							<option value="1er Cuatrimentre">1er Cuatrimentre</option>
 							<option value="2er Cuatrimentre">2er Cuatrimentre</option>
 						</select>
 				...
 				<div class="modal-footer">
 					<button type="submit" class="btn btn-primary">Crear Materias</button>
